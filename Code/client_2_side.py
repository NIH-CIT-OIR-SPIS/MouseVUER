...
def main():
    ...
    client = Client(server_sni_hostname, '127.0.0.1', PORT_CLIENT_LISTEN, server_cert, client_cert, client_key)
    client.connect_to_server('127.0.0.1', PORT_CLIENT_LISTEN)
    return 0
